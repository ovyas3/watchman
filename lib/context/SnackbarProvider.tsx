...
//   console.log("🚀 ~ file: SnackbarProvider.tsx:44 ~ useSnackbar ~ context:", context)
  if (!context) {
  ...
  return useCallback(
    (snack: SnackbarType) => {
      ...
      console.log("🚀 ~ file: SnackbarProvider.tsx:53 ~ useSnackbar ~ payload: { current: snack }:", { current: snack })
    },
    [dispatch]
  );
};