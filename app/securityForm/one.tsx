...
function SecurityForm({ searchParams }: props) {
  ...
  const [checklists3, setChecklists3] = useState<ChecklistItem[]>([
    ...
    // },
    {
      point: '3.What is the final loaded weight in kilograms as shown in the provided image, and does the image include the Weigh Bridge Slip, if applicable?',
      image: ''
    },
    {
        ...
        return stageData.every(item => {
          switch (item.point) {
            ...
            case "Have the E-way bill and Invoice been verified to have valid and current dates?":
              return !!item.dropdown;
            case "Has a thorough check of the vehicle been completed to identify any materials not listed on the invoice?":
              return !!item.dropdown;  
            default:
              return true;
          }
